# 13. Напишите программу, которая определит позицию второго вхождения строки в списке либо сообщит, что её нет.
# Пример:
...
# count = 0
# for i in range(len(b)): # range(len(b) - чтоб перебирать элементы строки
#     if b[0] == b[i]:
#         count += 1
#     if count == 2:
#         print(i+1)
