# 11. Иван решил создать самый большой словарь в мире. 
...
def Biggest_dict(**kwargs): # бесконечное значение элементов
    our_dict.update(**kwargs) # update добавляет в словарь

Biggest_dict(k1=22, k2=31, k3=11, k4=91) # вызываем функцию
Biggest_dict(name='Елена', age=31, weight=61, eyes_color='grey')
print(our_dict) # выводим на печать